...
class PostModel(models.Model):
	...
	rt          = models.TextField(blank=True, default='')
	rw          = models.TextField(blank=True, default='')
	desa_kelurahan = models.TextField(blank=True, default='')
	kecamatan   = models.TextField(blank=True, default='')
	kabupaten_kota = models.TextField(blank=True, default='')
	kode_pos    = models.TextField(blank=True, default='')
	provinsi    = models.TextField(blank=True, default='')
	nama_kepala_desa = models.TextField(blank=True, default='')
